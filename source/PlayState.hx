	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'ashura':
			{
				...
				defaultCamZoom = 0.80;
                curStage = 'ashura';
				var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('ashura/bgWalls'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.2, 0.2);
				bg.active = false;
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				...
				bottomBoppers = new FlxSprite(-300, 140);
				bottomBoppers.frames = Paths.getSparrowAtlas('ashura/bottomBop');
				bottomBoppers.animation.addByPrefix('bop', 'Bottom Level Boppers', 24, false);
				bottomBoppers.antialiasing = true;
				bottomBoppers.scrollFactor.set(0.9, 0.9);
				bottomBoppers.setGraphicSize(Std.int(bottomBoppers.width * 1));
			    ...
			    var fgSnow:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('ashura/fgSnow'));
				fgSnow.active = false;
				fgSnow.antialiasing = true;
				add(fgSnow);
			}
				case 'ashuramad':
			{
				...
				defaultCamZoom = 0.80;
                curStage = 'ashuramad';
				var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('ashuramad/unknown'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.2, 0.2);
				bg.active = false;
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				...
				var fgSnow:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('ashuramad/fgSnow'));
				fgSnow.active = false;
				fgSnow.antialiasing = true;
				add(fgSnow);
			}	
